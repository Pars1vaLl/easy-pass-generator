        ...
        <div className="glass-card rounded-2xl p-8 space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#111118] px-3 text-[#4b5563]">or continue with</span>
            </div>
          </div>

          {/* Tab toggle */}
          <div className="flex rounded-xl border border-[#1e1e2e] p-1 bg-[#09090f]">
            {(["email", "phone"] as const).map((t) => (
              <button
                ...
                className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all capitalize ${
                  tab === t
                    ? "bg-[#7c5af5]/20 text-[#f0f0f0] border border-[#7c5af5]/30"
          ...
          <p className="text-center text-sm text-[#4b5563]">
            ...
            <Link href="/register" className="text-[#7c5af5] hover:text-[#a78bfa] font-semibold transition-colors">
              Sign up free
            </Link>
          </p>
        </div>
